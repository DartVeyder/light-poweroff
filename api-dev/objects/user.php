    ...
    class User{
        ...
        if ($where) {
            ...
            $query_where = "";
                ...
                $query = "SELECT 
                u.user_id, u.region_id, u.user_telegram_id, u.group_id, u.username, u.first_name, u.last_name, 
                u.language_code, u.notification, u.active, u.date_added, u.date_modified, u.date_last_activity, u.date_not_active,
